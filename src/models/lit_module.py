...
class KGAugmentedLMLitModule(LightningModule):
    ...
    def __init__(
        ...
        # metric objects for calculating and averaging BLEU scores across batches
        ...
        # for tracking best so far validation performance
    ...
    def on_validation_epoch_end(self) -> None:
        ...
        # get current val {metric} and update best so far val {metric}
        acc = self.val_acc.compute()
        self.val_acc_best(acc) 
        bleu = self.val_bleu.compute()
        self.val_bleu_best(bleu)
        # log `val_{metric}_best` as a value through `.compute()` method, instead of as a metric object
...
if __name__ == "__main__":
    _ = KGAugmentedLMLitModule(None, None, None)
